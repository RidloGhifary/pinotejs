...
export function CodeBlock({ code, label }: CodeBlockProps) {
  ...
  return (
    <div className="min-w-0 overflow-hidden rounded-2xl border border-white/10 bg-slate-950/80 shadow-2xl shadow-black/30">
      ...
      <pre className="max-w-full overflow-x-auto p-5 text-sm leading-7 text-slate-200">
        <code>{code}</code>
      </pre>
    </div>
  );
